...
namespace Game
{
    public partial class PlayerController
    {
        ...
        private float staminaRecoverIntervalTimer = 0f;
        ...
        private void RecoverStamina(float deltatime) {
            ...
            if (staminaRecoverConuntdown <= 0) { 
                staminaRecoverIntervalTimer += deltatime;
                if (staminaRecoverIntervalTimer >= Constants.staminaRecoverInterval) {
                    staminaRecoverIntervalTimer = 0;
                    Stamina += 1;
                }
            }
            else {
